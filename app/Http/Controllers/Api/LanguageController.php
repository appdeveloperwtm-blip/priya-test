...
class LanguageController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($language as $languages) {
            if ($languages && isset($languages->thumble)) {
                $languages->thumble = $languages->thumble ? asset($languages->thumble) : null;
            }
        }
    ...
    public function languagedetails($id)
    {
        ...
        if ($language && isset($language->thumble)) {
            $language->thumble = $language->thumble ? asset($language->thumble) : null;
        }
        if ($language) {
            return response()->json([
                'status' => 'success',
